...
into a supercomputer that can be turned on instantly and billed at a 100ms
granularity. 

We take advantage of this *feature* and run a full-blown deep neural network
based face recognition tool ([openface](https://cmusatyalab.github.io/openface/)
on AWS lambda which can be used to detect and recognize faces in jpeg images
with zero configuration or model tuning.
